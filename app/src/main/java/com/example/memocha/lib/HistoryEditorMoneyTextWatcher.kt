...
class HistoryEditorMoneyTextWatcher(val c: Context, editText: EditText) : TextWatcher {

    private var parent = c as HistoryDetailsActivity
    ...
    override fun afterTextChanged(s: Editable?) {
        ...
        parent.historyDetailsEditor?.checkSaveButtonEnable()
    }
